...
export const Bar = forwardRef<HTMLDivElement, Props>(function Bar(
  ...
  return (
    ...
    >
      ...
      <button id="netSpeed" aria-label={`Network Speed: Video ${bar.videoSpeed || '0 B/s'} · Device ${bar.deviceSpeed || '--'}`} onClick={() => act('netSpeed')}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <span id="netSpeedLabel">{bar.videoSpeed || '0 B/s'}</span>
      </button>
      <span className="sep" />
